...
public class FlowWriterServiceImpl implements FlowWriterService {
	...
	System.out.println("Adding Flow Rule between "+sourceMac.getValue()+" & "+destMac.getValue()+ " to table "+tableId);
	...
	System.out.println("destPortUri = "+destPortUri.getValue()+"\ndestPort = "+destPort.getValue());
