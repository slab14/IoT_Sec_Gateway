...
public class SwitchDemoCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SwitchDemoCliTestCommand.class);
    protected final SwitchDemoCliCommands service;

    public SwitchDemoCliTestCommand(final SwitchDemoCliCommands service) {
