 ...
 */
package edu.cmu.slab.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import edu.cmu.slab.cli.api.DockerTestCliCommands;
...
public class DockerTestCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(DockerTestCliTestCommand.class);
    protected final DockerTestCliCommands service;

    public DockerTestCliTestCommand(final DockerTestCliCommands service) {
