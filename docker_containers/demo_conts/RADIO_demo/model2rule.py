...
'''
    ...
    def generateRule(self, sid, tid):
        ...
        if "Read" in self.transMatrix[sid][tid]:
            ...
            return f'{header} (flow:established; {content} {flowbits} {rule_id} {rev_id} {priority})' 
    ...
    def allowSYN(self):
        ...
        priority = f'priority:{self.priority};'
        self.rule_id += 1
        return f'{header} (flags:S; {rule_id} {rev_id} {priority})'
    ...
    def allowSYNACK(self):
        ...
        priority = f'priority:{self.priority};'
        self.rule_id += 1
        return f'{header} (flags:SA; {rule_id} {rev_id}  {priority})'
    ...
    def allowFIN(self):
        ...
        priority = f'priority:{self.priority};'
        self.rule_id += 1
        return f'{header} (flags:F+; {rule_id} {rev_id}  {priority})'
    ...
    def allowACK(self):
        ...
        priority = f'priority:{self.priority};'
        self.rule_id += 1
        return f'{header} (flags:A; dsize:0; {rule_id} {rev_id} {priority})'
    ...
    def dropAll(self):
        ...
        priority = f'priority:{self.priority};'
        self.rule_id += 1
        return f'{header} ({rule_id} {rev_id} {priority})'
