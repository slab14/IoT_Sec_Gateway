...
sudo ethtool -K eth1 tx off rx off gro off
sudo ethtool -K eth2 tx off rx off gro off
...
sudo ovs-vsctl --may-exist add-port br0 eth0 -- set Interface eth0 ofport_request=4
